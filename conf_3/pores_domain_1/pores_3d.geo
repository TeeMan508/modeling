...
Line(12) = {1, 3};
//+
Sphere(1) = {0.5, 0.5, 0.5, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(2) = {0, 1, 0, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(3) = {0, 1, 1, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(4) = {1, 1, 0, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(5) = {1, 1, 1, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(6) = {0, 0, 0, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(7) = {0, 0, 1, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(8) = {1, 0, 0, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
Sphere(9) = {1, 0, 1, 0.43, -Pi/2, Pi/2, 2*Pi};
//+
